...
public class EnvelopePrinterTest {
    ...
    public void should_print_correct_envolope() {
        ...
        String result = printer.printEnvelope(new UserName("Xiaoming", "Li"), new UserAddress("100007", "Beijing", "No.3 Dongzhimen South Street", "Room 1105, GuoHua Plaza", "18811111111"));
